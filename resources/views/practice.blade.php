...
{{--        <div class="video fh5co-video" style="background-image: url({{asset('frontend')}}/assets/images/video.jpg);">--}}
...
{{--                                    <figure>--}}
{{--                                        <img src="{{asset('frontend')}}/assets/images/user-1.jpg" alt="user">--}}
{{--                                    </figure>--}}
...
{{--                        <a href="#"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/project-4.jpg" alt=""></a>--}}
{{--                        <div class="blog-text">--}}
...
{{--                <div class="col-lg-4 col-md-4">--}}
{{--                    <div class="fh5co-blog animate-box">--}}
{{--                        <a href="#"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/project-2.jpg" alt=""></a>--}}
{{--                        <div class="blog-text">--}}
{{--                            <span class="posted_on">Nov. 15th</span>--}}
{{--                            <span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>--}}
...
{{--                <div class="col-lg-4 col-md-4">--}}
{{--                    <div class="fh5co-blog animate-box">--}}
{{--                        <a href="#"><img class="img-responsive" src="{{asset('frontend')}}/assets/images/project-3.jpg" alt=""></a>--}}
{{--                        <div class="blog-text">--}}
{{--                            <span class="posted_on">Nov. 15th</span>--}}
{{--                            <span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>--}}
{{--                            <h3><a href="#">Business Law</a></h3>--}}
...
{{--                        <img src="{{asset('frontend')}}/assets/images/user-2.jpg" alt="Free HTML5 Templates by gettemplates.co">--}}
{{--                        <h3>Jean Smith</h3>--}}
